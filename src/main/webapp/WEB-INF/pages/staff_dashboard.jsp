            ...
            <div class="dashboard-wrapper">
                ...
                <aside class="sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <a href="#" class="nav-item active" onclick="switchStaffTab('myTasks', this)"><i
                                data-lucide="layout-dashboard"></i> Dashboard</a>
                        <a href="#" class="nav-item" onclick="switchStaffTab('overview', this)"><i
                                data-lucide="clipboard-list"></i> All Incidents</a>
                        <a href="#" class="nav-item" onclick="switchStaffTab('mapView', this)"><i data-lucide="map"></i>
                            Map View</a>
                    </nav>
                ...
                <div class="main-content-wrapper">
                    ...
                    <div class="top-bar">
                        <div class="top-bar-search">
                            ...
                            <input type="text" id="staffSearchInput"
                                placeholder="Search reports, animals, or locations..." onkeyup="filterStaffReports()">
                        </div>
                            ...
                            <div class="profile-section">
                                <% String staffProfileImg=(String) session.getAttribute("userProfileImage"); %>
                                    <% if (staffProfileImg !=null && !staffProfileImg.isEmpty()) { %>
                                        <img src="${pageContext.request.contextPath}/<%= staffProfileImg %>"
                    ...
                    <main class="main-content">
                        ...
                        <% if("success".equals(request.getParameter("update"))) { %>
                            <div class="alert alert-success"><i data-lucide="check-circle"></i> Completion report
                                submitted! Awaiting admin verification.</div>
                            <% } %>
                                <% if("success".equals(request.getParameter("applied"))) { %>
                                    <div class="alert alert-success"><i data-lucide="check-circle"></i> Assignment
                                        request sent! Awaiting admin approval.</div>
                                    <% } %>
                                        <% if("already".equals(request.getParameter("applied"))) { %>
                                            <div class="alert alert-warning"><i data-lucide="info"></i> This incident is
                                                no longer available for assignment.</div>
                                            <% } %>
                                                ...
                                                <div class="stat-cards">
                                                    <div class="stat-card">
                                                        ...
                                                        <span class="stat-value">${totalReports != null ? totalReports :
                                                            0}</span>
                                                    </div>
                                                    <div class="stat-card">
                                                        ...
                                                        <span class="stat-value">${pendingCount != null ? pendingCount :
                                                            0}</span>
                                                    </div>
                                                    <div class="stat-card">
                                                        <div class="stat-icon bg-blue"><i data-lucide="user-check"></i>
                                                        </div>
                                                        <span class="stat-label">Assigned</span>
                                                        <span class="stat-value">${assignedCount != null ? assignedCount
                                                            : 0}</span>
                                                    </div>
                                                    <div class="stat-card">
                                                        ...
                                                        <span class="stat-value">${resolvedCount != null ? resolvedCount
                                                            : 0}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="tab-myTasks" class="tab-content active">
                                                    <div class="section-header"><i data-lucide="briefcase"></i>
                                                        <h2>My Tasks</h2>
                                                    </div>
                                                    <p class="section-desc">Incidents assigned to you. Accept, deny, or
                                                        submit completion.</p>

                                                    <div class="incidents-container" style="margin-top: 14px;">
                                                        <div class="incidents-header"><i data-lucide="briefcase"></i>
                                                            Your Assignments</div>
                                                        <div class="incidents-grid">
                                                            <!-- User-specific task loop -->
                                                            <c:forEach items="${myTasks}" var="task">
                                                                <div class="report-card cat-${task.category == 'Carcass' ? 'carcass' : task.category == 'Injured' ? 'injured' : 'wild'}"
                                                                    id="task-card-${task.id}">
                                                                    <div
                                                                        class="card-icon icon-${task.category == 'Carcass' ? 'carcass' : task.category == 'Injured' ? 'injured' : 'wild'}">
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${task.category == 'Carcass'}"><i
                                                                                    data-lucide="heart-off"></i>
                                                                            </c:when>
                                                                            <c:when
                                                                                test="${task.category == 'Injured'}"><i
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="card-meta">
                                                                            <span
                                                                                class="badge badge-${task.category == 'Carcass' ? 'user' : task.category == 'Injured' ? 'red' : 'pending'}">${task.category}</span>
                                                                            <span
                                                                                class="badge badge-${task.status == 'REQUESTED' ? 'requested' : task.status == 'ASSIGNED' ? 'assigned' : task.status == 'COMPLETED' ? 'completed' : task.status == 'FORCE_ASSIGNED' ? 'force_assigned' : 'resolved'}"
                                                                                id="task-badge-${task.id}">${task.status}</span>
                                                                        </div>
                                                                        <c:if test="${task.locationDesc != null}">
                                                                            <div class="card-location"><i
                                                                                    data-lucide="map-pin"></i>
                                                                                ${task.locationDesc}</div>
                                                                        </c:if>
                                                                        <c:if test="${task.photoPath != null}">
                                                                            <img src="${pageContext.request.contextPath}/${task.photoPath}"
                                                                                alt="Task photo" class="card-photo">
                                                                        </c:if>
                                                                        ...
                                                                        <div class="card-actions"
                                                                            ...
                                                                            <c:if test="${task.status == 'REQUESTED'}">
                                                                                <span
                                                                                    style="font-size: 0.8rem; color: #6a1b9a; font-weight: 700; padding: 7px 0;">Awaiting
                                                                                    Admin Approval</span>
                                                                            </c:if>
                                                                            <c:if
                                                                                test="${task.status == 'FORCE_ASSIGNED'}">
                                                                                <button type="button"
                                                                                    class="btn btn-approve btn-sm"
                                                                                    style="flex:1; margin:0;"
                                                                                    onclick="staffTaskAction('${pageContext.request.contextPath}', ${task.id}, 'acceptAssignment')"><i
                                                                                        data-lucide="check"
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    style="flex:1; margin:0;"
                                                                                    onclick="staffTaskAction('${pageContext.request.contextPath}', ${task.id}, 'denyAssignment')"><i
                                                                                        data-lucide="x"
                                                                                        style="width:14px;height:14px;"></i>
                                                                                    Deny</button>
                                                                            </c:if>
                                                                            <c:if test="${task.status == 'ASSIGNED'}">
                                                                                <button type="button"
                                                                                    ...
                                                                                    onclick="staffTaskAction('${pageContext.request.contextPath}', ${task.id}, 'complete')"><i
                                                                                        data-lucide="check"
                                                                                        style="width:14px;height:14px;"></i>
                                                                            ...
                                                                            <c:if test="${task.status == 'COMPLETED'}">
                                                                                <span
                                                                                    style="font-size: 0.8rem; color: var(--color-info, #1976d2); font-weight: 700; padding: 7px 0;">Awaiting
                                                                                    Verification</span>
                                                                            </c:if>
                                                                            <c:if test="${task.status == 'RESOLVED'}">
                                                                                <span
                                                                                    style="font-size: 0.8rem; color: var(--color-primary); font-weight: 700; padding: 7px 0;">&#10003;
                                                                                    Verified & Resolved</span>
                                                                            </c:if>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div id="tab-overview" class="tab-content">
                                                    <div class="section-header"><i data-lucide="clipboard-list"></i>
                                                        <h2>All Incidents</h2>
                                                    </div>
                                                    ...
                                                    <div class="search-filter-bar">
                                                        <input type="text" placeholder="Filter incidents..."
                                                            onkeyup="filterStaffReports()" id="staffSearchInline">
                                                        <select id="staffFilterCategory"
                                                            onchange="filterStaffReports()">
                                                                ...
                                                                <div class="report-card cat-${report.category == 'Carcass' ? 'carcass' : report.category == 'Injured' ? 'injured' : 'wild'}"
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="card-meta">
                                                                            ...
                                                                            <span
                                                                                class="badge badge-${report.status == 'PENDING' ? 'pending' : report.status == 'REQUESTED' ? 'requested' : report.status == 'ASSIGNED' ? 'assigned' : report.status == 'COMPLETED' ? 'completed' : report.status == 'FORCE_ASSIGNED' ? 'force_assigned' : 'resolved'}"
                                                                                id="staff-badge-${report.id}">${report.status}</span>
                                                                        ...
                                                                        <div class="card-actions"
                                                                            id="staff-actions-${report.id}">
                                                                            <c:if test="${report.status == 'PENDING'}">
                                                                                <button type="button"
                                                                                    class="btn btn-primary btn-sm"
                                                                                    style="width:100%; margin:0;"
                                                                                    onclick="staffApplyAction('${pageContext.request.contextPath}', ${report.id})"><i
                                                                                        data-lucide="hand"
                                                                                        style="width:14px;height:14px;"></i>
                                                                                    Request Assignment</button>
                                                                            </c:if>
                                                                            <c:if
                                                                                test="${report.status == 'REQUESTED'}">
                                                                                <span
                                                                                    style="font-size: 0.8rem; color: #6a1b9a; font-weight: 700; padding: 7px 0;">Awaiting
                                                                                    Approval</span>
                                                                            </c:if>
