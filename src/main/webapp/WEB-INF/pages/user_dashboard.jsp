...
<body>
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="#" class="nav-item active" onclick="switchUserTab('myReports', this)"><i data-lucide="layout-dashboard"></i> Dashboard</a>
                <a href="#" class="nav-item" onclick="switchUserTab('allReports', this)"><i data-lucide="file-text"></i> All Reports</a>
                <a href="#" class="nav-item" onclick="switchUserTab('heatmap', this)"><i data-lucide="map"></i> Map View</a>
            </nav>
        ...
        <div class="main-content-wrapper">
            ...
            <div class="top-bar">
                <div class="top-bar-search">
                    ...
                    <input type="text" id="searchInput" placeholder="Search reports, animals, or locations..." onkeyup="filterReports()">
                </div>
                <div class="top-bar-right">
                    ...
                    <div class="profile-section">
                        ...
                        <% if (profileImg != null && !profileImg.isEmpty()) { %>
                            <img src="${pageContext.request.contextPath}/<%= profileImg %>" alt="Profile" class="profile-avatar">
                        <% } else { %>
                            <div class="top-bar-icon" style="border:none;"><i data-lucide="user"></i></div>
                        <% } %>
                        <span class="profile-name"><%= session.getAttribute("userName") != null ? session.getAttribute("userName") : "Guardian" %></span>
                    </div>
                </div>
            </div>
            ...
            <main class="main-content">
                ...
                <div id="tab-myReports" class="tab-content active">
                    ...
                    <div class="hero-banner">
                        <div class="hero-banner-content">
                            ...
                            <p>Every report helps save a life. Quick view to your active missions and community alerts.</p>
                        </div>
                        <img src="${pageContext.request.contextPath}/images/hero_tiger.png" alt="Wildlife" class="hero-banner-image">
                    </div>
                    ...
                    <div class="search-filter-bar">
                        <input type="text" placeholder="Filter your reports..." onkeyup="filterReports()" id="searchInputInline">
                    ...
                    <div class="incidents-container">
                        <div class="incidents-header"><i data-lucide="activity"></i> <span class="live-dot" style="width:8px;height:8px;border-radius:50%;background:#d32f2f;display:inline-block;animation:pulse-dot 2s infinite;margin-right:4px;"></span> Your Submissions</div>
                ...
                <div id="tab-allReports" class="tab-content">
                    <div class="section-header"><i data-lucide="file-text"></i><h2>All Community Reports</h2></div>
                    <p class="section-desc">Browse all reports submitted by the community. Total: ${totalReports} reports.</p>

                    <!-- Advanced Filters for Community Data -->
                    <div class="search-filter-bar" style="margin-top:12px;">
                        <input type="text" placeholder="Search all reports..." id="allReportsSearch" onkeyup="filterAllUserReports()">
                        <select id="allReportsCategory" onchange="filterAllUserReports()">
                            <option value="all">All Categories</option>
                            <option value="Carcass">Carcass</option>
                            <option value="Injured">Injured</option>
                            <option value="Wild Sighting">Wild Sighting</option>
                    ...
                    <div class="incidents-container" style="margin-top:12px;">
                        <div class="incidents-header"><i data-lucide="globe"></i> Community Reports</div>
    ...
    <div id="reportModal" class="modal-backdrop hidden">
        <div id="modalContentBox" class="modal-content theme-carcass">
            <h2 id="modalDynamicTitle" style="color: var(--color-text-dark); font-size: 1.25rem; margin-bottom: 6px;">Report Sighting</h2>
            <p id="modalDynamicDesc" style="color: var(--color-text-muted); font-size: 0.88rem; margin-bottom: 16px;">Provide details to assist our team.</p>
            ...
            <form action="${pageContext.request.contextPath}/report/submit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div id="pickerMap" style="height: 160px; width: 100%; margin-bottom: 6px; border-radius: var(--radius-md); overflow: hidden;"></div>
                    <input type="text" name="location" id="locationInput" class="form-control" style="background: var(--color-bg-light); font-size: 0.88rem;" readonly>
                </div>
    ...
    <div id="detailModal" class="modal-backdrop hidden">
        <div class="modal-content">
            <h2 id="detailViewTitle" style="color: var(--color-text-dark); font-size: 1.25rem; margin-bottom: 12px;">Incident Details</h2>
            <div style="background: var(--color-bg-light); padding: 16px; border-radius: var(--radius-md); margin-bottom: 18px;">
                <p style="margin-bottom: 8px;"><strong style="color: var(--color-text-muted);">Category:</strong> <span id="detailViewCategory"></span></p>
                <p style="margin-bottom: 8px;"><strong style="color: var(--color-text-muted);">Status:</strong> <span id="detailViewStatus" style="font-weight: 700;"></span></p>
                <p style="margin-bottom: 8px;"><strong style="color: var(--color-text-muted);">Location:</strong> <span id="detailViewLocation"></span></p>
                <hr style="border: none; border-top: 1px solid var(--color-border); margin: 10px 0;">
                <p><strong style="color: var(--color-text-muted);">Description:</strong> <span id="detailViewDesc" style="color: var(--color-text-dark);"></span></p>
            </div>
            <div class="modal-actions">
                <button type="button" onclick="closeDetailModal()" class="btn-cancel">Close</button>
                <button type="button" onclick="locateIncidentOnMap()" class="modal-submit-btn"><i data-lucide="map-pin" style="width:14px;height:14px;display:inline;vertical-align:middle;"></i> View on Map</button>
            </div>
        </div>
    </div>
    ...
    <div id="applyRoleModal" class="modal-backdrop hidden">
        <div class="modal-content">
            <h2 style="color: var(--color-text-dark); font-size: 1.25rem; margin-bottom: 6px;">Apply for a Role</h2>
            <p style="color: var(--color-text-muted); font-size: 0.88rem; margin-bottom: 18px;">Join our team and help protect wildlife.</p>
