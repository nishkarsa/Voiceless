                    ...
                    <% } %>
                        ...
                        <form action="${pageContext.request.contextPath}/admin/login" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="token" class="form-control" placeholder="Enter password"
                                    required>
                            </div>
                        ...
                        <img src="${pageContext.request.contextPath}/images/rhino_wildlife.png" alt="Rhino"
